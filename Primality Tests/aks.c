/*
  This code has been taken from github. Using it for academic purposes due to the complexity of this algorithm
  for comparing the primality test comparison.
*/
